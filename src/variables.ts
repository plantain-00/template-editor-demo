...
import { CollectionEditor } from "./template-editor/collection-editor"
...
import { VariableEditor } from "./template-editor/variable-editor"
...
// @ts-ignore
export function templateEditorCollectionEditorTemplateHtml(this: CollectionEditor) {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.canvasState.collectionEditorVisible)?_c('div',{style:(_vm.editorStyle)},[_c('textarea',{staticStyle:{"width":"calc(100% - 40px)","height":"400px","margin-left":"20px","margin-right":"20px"},domProps:{"value":_vm.collection},on:{"blur":_vm.changeCollection}})]):_vm._e()}
// @ts-ignore
export var templateEditorCollectionEditorTemplateHtmlStatic = [  ]
// @ts-ignore
...
// @ts-ignore
export function templateEditorTemplateEditorTemplateHtml(this: TemplateEditor) {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticStyle:{"display":"flex"}},[_c('div',{style:(_vm.layerPanelStyle)},[_c('layer-panel',{attrs:{"canvasState":_vm.canvasState}})],1),_vm._v(" "),_c('div',{style:(_vm.canvasStyle)},[_c('render-layer',{attrs:{"canvasState":_vm.canvasState}}),_vm._v(" "),_c('selection-layer',{attrs:{"canvasState":_vm.canvasState}}),_vm._v(" "),_c('hover-layer',{attrs:{"canvasState":_vm.canvasState}}),_vm._v(" "),_c('dragging-for-selection-layer',{attrs:{"canvasState":_vm.canvasState}}),_vm._v(" "),_c('mask-layer',{attrs:{"canvasState":_vm.canvasState}}),_vm._v(" "),_c('context-menu',{attrs:{"canvasState":_vm.canvasState}})],1),_vm._v(" "),_c('div',{style:(_vm.operationPanelStyle)},[_c('operation-panel',{attrs:{"canvasState":_vm.canvasState}})],1),_vm._v(" "),_c('variable-editor',{attrs:{"canvasState":_vm.canvasState}}),_vm._v(" "),_c('collection-editor',{attrs:{"canvasState":_vm.canvasState}})],1)}
// @ts-ignore
export var templateEditorTemplateEditorTemplateHtmlStatic = [  ]
// @ts-ignore
export function templateEditorVariableEditorTemplateHtml(this: VariableEditor) {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.canvasState.variableEditorVisible)?_c('div',{style:(_vm.editorStyle)},[_c('textarea',{staticStyle:{"width":"calc(100% - 40px)","height":"400px","margin-left":"20px","margin-right":"20px"},domProps:{"value":_vm.variable},on:{"blur":_vm.changeVariable}})]):_vm._e()}
// @ts-ignore
export var templateEditorVariableEditorTemplateHtmlStatic = [  ]
// @ts-ignore
